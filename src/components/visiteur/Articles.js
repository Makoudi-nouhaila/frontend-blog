...
function Articles() {
  ...
  return (
    <>
    <Layout></Layout>
      <header style={{ padding: "2rem 0", background: "#f8f9fa", borderBottom: "1px solid #dee2e6", marginBottom: "2rem" }}>
  <div className="container">
    <div className="text-center my-5">
    <h1 style={{ fontFamily: "'Dancing Script', cursive", fontWeight: 900 }}>
  Welcome to Blog Home!
</h1>
<p className="lead mb-0" style={{ fontFamily: "'Libre Franklin', sans-serif", fontWeight: 900 }}>
